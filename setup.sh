...
echo ""
echo "🔌 Extension App Manifest URLs:"
echo "----------------------------------------------------------"
...
echo "SMTP / Email App:  https://smtp-app.udayamarketing.in/api/manifest"
echo "Search Engine App: https://search-app.udayamarketing.in/api/manifest"
echo "CMS Sync App:      https://cms-app.udayamarketing.in/api/manifest"
echo "Klaviyo CRM App:   https://klaviyo-app.udayamarketing.in/api/manifest"
echo "=========================================================="
echo "=========================================================="
